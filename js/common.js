/*
   Theme Name: Repal
   Author: Brainiak
   Description: Repal - Creative Responsive Minimalistic HTML Template
   Version: 1.0.0
*/
		...
		iframe: {
			...
			patterns: {
				youtube: {
					...
					src: '../../../../../www.youtube.com/embed/%id%_fa6dc463.html' // URL that will be set as a source for iframe.
				},
